...
.. _`Edit this file`: https://github.com/response42/cookiecutter-pypackage/blob/master/docs/tutorial.rst
...
.. code-block:: bash
    ...
    $ cookiecutter gh:response42/cookiecutter-pypackage --checkout v3.1.0
...
.. _`Issues`: https://github.com/response42/cookiecutter-pypackage/issues
